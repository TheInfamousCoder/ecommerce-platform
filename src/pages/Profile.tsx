...
const Tabs = [
  ...
  },
  {
    ...
    tabContent: "This is shipping address tab",
  },
  {
    id: "wishlist",
    tabIcon: <Star />,
    tabName: "Wishlist",
    tabContent: "This is whishlist tab",
  },
  {
    id: "orders",
    tabIcon: <Layers />,
  ...
  return (
    <div>
      ...
      <div className="container-rest py-16">
        {/* ----tabs--- */}
        <div className="flex justify-between gap-5 border-2 border-b-neutral-300 border-t-0 border-s-0 border-e-0 outline-0 w-3xl mx-auto mb-12">
          {Tabs.map((tab) => (
            <button
              key={tab.id}
              className={`cursor-pointer p-2 flex gap-2  ${isActive(tab.id) ? "border-b-2 border-primary bg-purple-200 text-primary" : ""}`}
